  ...
  return (
    ...
    >
      ...
      >
        ...
        <span data-part="thumb" className={`absolute top-[var(--sld-theme-toggle-thumb-inset-block)] left-[var(--sld-theme-toggle-thumb-inset-inline)] inline-flex items-center justify-center w-[var(--sld-theme-toggle-thumb-size)] h-[var(--sld-theme-toggle-thumb-size)] rounded-full bg-[var(--sld-theme-toggle-thumb-bg)] text-[var(--sld-theme-toggle-thumb-fg)] shadow-[var(--sld-shadow-xs)] transition-[transform,background-color] duration-[var(--sld-theme-toggle-duration-thumb)] [transition-timing-function:var(--sld-easingSnappy)] motion-reduce:transition-none ${isDark ? 'translate-x-[var(--sld-theme-toggle-thumb-translate)]' : 'translate-x-0'}`}>
