...
export const Default = () => (
  <div className="p-6 bg-[var(--solide-surface-card)] border border-[var(--solide-border-default)] rounded-xl max-w-lg shadow-md">
    <ModalHeader
...
export const DestructiveDialog = () => (
  <div className="p-6 bg-[var(--solide-surface-card)] border border-[var(--solide-border-danger)] rounded-xl max-w-lg shadow-md">
    <ModalHeader
