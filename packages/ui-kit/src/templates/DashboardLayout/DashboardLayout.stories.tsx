...
export const CompleteAppShell = () => {
  ...
  const sidebarSections = [
    {
      title: 'Plataforma',
      items: [
        { id: 'overview', label: 'Vis?o Geral', icon: 'activity', isActive: activeTab === 'overview', onClick: () => setActiveTab('overview') },
    ...
    },
    {
      title: 'Auditoria',
      items: [
        { id: 'logs', label: 'Logs de Execu??o', icon: 'filter', isActive: activeTab === 'logs', onClick: () => setActiveTab('logs') },
      ]
    }
  ];
  ...
  return (
    <DashboardLayout
      ...
      onSearchClick={() => alert('Abrir busca r?pida')}
    >
      <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <Typography variant="body-sm" tone="secondary">
              M?tricas de lat?ncia P99 e taxa de sucesso dos n?s de intelig?ncia artificial.
            </Typography>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-5 bg-[var(--solide-surface-base)] border border-[var(--solide-border-default)] rounded-xl shadow-xs">
            <Typography variant="caption" tone="muted">LAT?NCIA P99</Typography>
